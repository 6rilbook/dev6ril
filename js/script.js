function onSubmit() {
	/* Use this line of code to go directly to another page when the correct code is entered and the "submit" button is clicked. */
          /*if (document.getElementById('password').value == '145887') {window.location.href = 'http:google.com'; }else{ alert('Access Denied, Please try again');}*/
  ...
  /* (the new button that appears must also be clicked to go to the new page.) */ 
         if (document.getElementById('password').value == '1111') {window.button2.style.display="block"; }else{ alert('Accès impossible,réessayer encore');}
     }
